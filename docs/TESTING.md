...
- **API Contract Testing:** [Dredd](https://dredd.org/)
- **Performance Testing:** [k6](https://k6.io/)
- **Security Testing:** [Snyk](https://snyk.io/), [auditjs](https://github.com/OSSIndex/auditjs)
